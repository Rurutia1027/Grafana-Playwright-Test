...
test.describe(
  ...
  () => {
    test.describe('Sandbox disabled', () => {
      ...
      test.skip('Reaches out of the panel editor', async ({ gotoDashboardPage, page }) => {
        await gotoDashboardPage({
          uid: DASHBOARD_ID,
    ...
    test.describe('Sandbox enabled', () => {
      ...
      test.skip('Does not add iframes to body', async ({ page, gotoDashboardPage }) => {
        await gotoDashboardPage({
          uid: DASHBOARD_ID,
        });
      ...
      test.skip('Does not reaches out of panel div', async ({ page, gotoDashboardPage }) => {
        await gotoDashboardPage({
          uid: DASHBOARD_ID,
        });
