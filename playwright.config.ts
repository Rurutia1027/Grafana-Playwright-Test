...
export default defineConfig<PluginOptions>({
  ...
  projects: [
    ...
    withAuth({
      name: 'demo',
      testDir: path.join(testDirRoot),  // points to src/
      testMatch: ['demo.spec.ts'],      // only this file
      use: {
        ...devices['Desktop Chrome'],
        storageState: undefined,        // no auth needed for this demo
      },
    }),
  ], 
}); 